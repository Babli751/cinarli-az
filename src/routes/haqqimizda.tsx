...
export const Route = createFileRoute("/haqqimizda")({
  head: () => ({ meta: [{ title: "Haqqımızda — Manqo — Onlayn Ticarət Mərkəzi" }] }),
  component: () => (
    <PageShell title="Haqqımızda" subtitle="2008-ci ildən etibarlı mebel partnyoru.">
      <div className="prose prose-sm max-w-none text-foreground">
        <p>Manqo Azərbaycanda 56 mağazaya, 40 mindən çox məhsul çeşidinə və 2 milyondan çox müştəriyə xidmət edən aparıcı onlayn ticarət mərkəzidir.</p>
