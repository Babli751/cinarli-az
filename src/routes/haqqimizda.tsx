...
export const Route = createFileRoute("/haqqimizda")({
  head: () => ({ meta: [{ title: "Haqqımızda — MebelMart" }] }),
  component: () => (
    <PageShell title="Haqqımızda" subtitle="2008-ci ildən etibarlı mebel partnyoru.">
      <div className="prose prose-sm max-w-none text-foreground">
        <p>MebelMart Azərbaycanda 56 mağazaya, 40 mindən çox məhsul çeşidinə və 2 milyondan çox müştəriyə xidmət edən aparıcı mebel şəbəkəsidir.</p>
